...
case "$CHOICE" in
    1) # Open main README file
        clear && cat README.md | more
        ;;
    2) # doc 2
        clear && cat docs/szmelc.md | more
        ;;
    3) # doc 3
        clear && cat docs/101.md | more
        ;;
    4) # doc 4
        clear && cat docs/more.md | more
        ;;
    E) # Exit
